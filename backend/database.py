...
def seed_services():
    ...
    defaults = [
        ...
        ("Domain/DNS", "Cloudflare Tunnels", "https://one.dash.cloudflare.com/REDACTED_CF_ACCOUNT_ID                                                                                                                                                                                   /networks/connectors/cloudflare-tunnels/cfd_tunnel/475355a4-afce-4fc4-8b90-cd1e5da2fb60/edit?tab=publicHostname", "🚇", 8, 1),
        ("Domain/DNS", "Cloudflare DNS", "https://dash.cloudflare.com/REDACTED_CF_ACCOUNT_ID                                                                                                                                                                                   /pmserver.us/dns/records", "📋", 9, 2),
